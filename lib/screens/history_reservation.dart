...
import 'package:my_app/services/rezervacija.dart';

class HistorijaRezervacija extends StatefulWidget {
  @override
  _HistorijaRezervacijaState createState() => _HistorijaRezervacijaState();
}

class _HistorijaRezervacijaState extends State<HistorijaRezervacija> {
  @override
                        ...
                        home: Scaffold(
                            ...
                            body: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                if (data[index].prihvaceno == true || data[index].otkazano==true
                                 ) {
                                  return Card(
